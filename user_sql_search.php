...
function print_button($account_ID,$flight_id_1,$flight_id_2,$flight_id_3){
    accessDB($db);
    if($flight_id_2!="" && $flight_id_3!=""){
        $sql = <<<__SQL__
SELECT id, user_id FROM ticket_favorate
    ...
    if($sth->fetchObject()){
        ...
        <td>
            <form action="rm_ticket_favorate.php" method="POST">
                <input name="flight_id_1" value="{$flight_id_1}" hidden />
                <input name="flight_id_2" value="{$flight_id_2}" hidden />
                <input name="flight_id_3" value="{$flight_id_3}" hidden />
...
__HTML__;
        ...
        echo <<<__HTML__
        <td>
            <form action="add_ticket_favorate.php" method="POST">
                <input name="flight_id_1" value="{$flight_id_1}" hidden />
                <input name="flight_id_2" value="{$flight_id_2}" hidden />
                <input name="flight_id_3" value="{$flight_id_3}" hidden />
...
function no_transfer($depart,$dest,$order,$method,$account_ID)
{
    accessDB($db);
    $sql = <<<__SQL__
SELECT
...
__HTML__;
    ...
    while($data=$sth->fetchObject()){
        ...
        print_button($account_ID,$data->id,"","");
        echo '</tr>';
    }
    echo <<<__HTML__
    </table>
...
function one_transfer($depart,$dest,$order,$order_method,$account_ID)
{
    accessDB($db);
    $sql =<<<__SQL__
SELECT
        ...
        <table class="table table-striped" style="width: 1400px;">
            <tr>
                ...
                <th style="width: 700px;">
                    <table class="inner-block table-hover"><tr>
                        <th style="width: 110px;">Flight Number</th>
                        <th style="width: 130px;">Departure Airport</th>
                        <th style="width: 130px;">Destination Airport</th>
                        <th style="width: 150px;">Departure Time</th>
                        <th style="width: 150px;">Arrival Time</th>
                        <th style="width: 120px;">Flight Time</th>
                    </tr></table>
                </th>
                <th style="width: 120px;">Total Flight Time</th>
                <th style="width: 120px;">Transfer Time</th>
                <th style="width: 120px;">Total Time</th>
                <th style="width: 120px;">Price</th>
                <th style="width: 120px;">Favorate</th>
            </tr>
__HTML__;
...
__HTML__;
            ...
            print_button($account_ID,$data->one_first_id,$data->one_second_id,"");
            echo '</tr>';
            ...
            echo '<tr>';
            echo '<td style="width: 50px;">' . ++$counter . '</td>';
            echo '<td style="width: 700px;"><table class="inner-block table-hover"><tr>';
...
function two_transfer($depart,$dest,$order,$order_method,$account_ID)
{
    accessDB($db);
    $sql = <<<__SQL__
SELECT
...
__SQL__;
    ...
    <th style="width: 700px;">
        <table class="inner-block table-hover"><tr>
            ...
            <th style="width: 150px;">Departure Time</th>
            <th style="width: 150px;">Arrival Time</th>
            <th style="width: 150px;">Flight Time</th>
        </tr></table>
    </th>
    <th style="width: 120px;">Total Flight Time</th>
    <th style="width: 120px;">Transfer Time</th>
    ...
    while($data=$sth->fetchObject()){
        if($data->two_second_flight_number !== NULL && $data->two_third_flight_number !== NULL){
            ...
            <table class="inner-block table-hover">
                ...
                <td style="width: 150px;">{$data->flight_time_1}</td></tr>
                <tr><td style="width: 110px;">{$data->two_second_flight_number}</td>
...
__HTML__;
            ...
            echo '<td style="width: 120px;">' . $data->total_time . '</td>';
            echo '<td style="width: 120px;">' . $data->price . '</td>';
            print_button($account_ID,$data->two_first_id,$data->two_second_id,$data->two_third_id);
            echo '</tr>';
        }
...
__HTML__;
            ...
            echo '<tr>';
            echo '<td style="width: 50px;">' . ++$counter . '</td>';
            echo '<td style="width: 700px;"><table><tr>';
